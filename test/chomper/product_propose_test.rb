...
module Chomper
  ...
  class ProductProposeTest < Minitest::Test
    ...
    def runner(claude: nil, openspec: nil, op: nil)
      ProductRunner.new(@ctx, op: op || FakeOP.new, intake: Object.new,
    ...
    def test_the_loop_gives_up_after_the_attempt_cap
      ...
      assert_equal ProductRunner::MAX_VALIDATE_ATTEMPTS, claude.prompts.length
