...
module OPilot
  class GhPullTest < Minitest::Test
    ...
    def test_returns_intent_for_a_opilot_comment
      gh = pull(issue: [issue_c(id: 1, body: "@opilot please guard nil", login: "thykel", at: "2026-06-18T18:05:00Z")])
    ...
    def test_carries_the_head_repo_fork_for_fetch_and_push
      gh = pull(issue: [issue_c(id: 1, body: "@opilot go", login: "thykel", at: "2026-06-18T18:05:00Z")],
    ...
    def test_does_not_react_to_off_allowlist_comments
      gh = pull(issue: [issue_c(id: 9, body: "@opilot go", login: "rando", at: "2026-06-18T18:05:00Z")])
      gh.poll_intents("2000-01-01T00:00:00Z")
      assert_empty @github.reacted
    end

    def test_review_reply_carries_kind_and_parent
      gh = pull(review: [review_c(id: 5, body: "@opilot fix this", login: "thykel",
    ...
    def test_mentioning_the_bots_github_login_triggers
      gh = pull(issue: [issue_c(id: 1, body: "@opilot-bot please guard nil", login: "thykel", at: "2026-06-18T18:05:00Z")])
      assert_equal 1, gh.poll_intents("2000-01-01T00:00:00Z").length
    end

    def test_refresh_comment_carries_the_refresh_command
      gh = pull(issue: [issue_c(id: 1, body: "@opilot refresh", login: "thykel", at: "2026-06-18T18:05:00Z")])
    ...
    def test_refresh_command_works_with_the_bots_login_too
      gh = pull(issue: [issue_c(id: 1, body: "@opilot-bot refresh please", login: "thykel", at: "2026-06-18T18:05:00Z")])
      assert_equal :refresh, gh.poll_intents("2000-01-01T00:00:00Z").first.command
    end
    ...
    def test_allowlist_rejects_other_users_and_advances_cutoff
      gh = pull(issue: [issue_c(id: 9, body: "@opilot do it", login: "rando", at: "2026-06-18T18:05:00Z")])
      assert_empty gh.poll_intents("2000-01-01T00:00:00Z")
    ...
    def test_scan_from_floor_excludes_older_comments
      gh = pull(issue: [issue_c(id: 1, body: "@opilot old one", login: "thykel", at: "2024-01-01T00:00:00Z")])
      assert_empty gh.poll_intents("2024-06-01T00:00:00Z")
    end

    def test_skips_opilots_own_recorded_replies
      gh = pull(issue: [issue_c(id: 1, body: "@opilot hi", login: "thykel", at: "2026-06-18T18:05:00Z")])
      gh.record_opilot_comment("42", "openproject", 1)
      assert_empty gh.poll_intents("2000-01-01T00:00:00Z")
    end
    ...
    def test_caches_full_pr_content_including_copilot_review
      gh = pull(
        issue:   [issue_c(id: 1, body: "@opilot go", login: "thykel", at: "2026-06-18T18:05:00Z")],
    ...
    def test_reuses_cache_while_pr_updated_at_is_unchanged
      ...
      gh2 = pull(issue: [issue_c(id: 1, body: "@opilot go", login: "thykel", at: "2026-06-18T18:05:00Z"),
                         issue_c(id: 2, body: "@opilot again", login: "thykel", at: "2026-06-18T18:06:00Z")])
      gh2.record_opilot_comment("42", "openproject", 1)            # id 1 already handled
    ...
    def test_refetches_when_pr_updated_at_changes
      ...
      gh2 = pull(issue: [issue_c(id: 2, body: "@opilot again", login: "thykel", at: "2026-06-18T18:30:00Z")],
                 pr_obj: pr(updated_at: "2026-06-18T18:30:00Z"))
      gh2.record_opilot_comment("42", "openproject", 1)
      intents = gh2.poll_intents("2000-01-01T00:00:00Z")
    ...
    def test_a_comment_trigger_suppresses_the_ci_intent_this_tick
      gh = pull(
        issue:      [issue_c(id: 1, body: "@opilot please tweak", login: "thykel", at: "2026-06-18T18:05:00Z")],
