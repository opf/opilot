...
module OPilot
  class PrRunnerTest < Minitest::Test
    ...
    def open_pr(state: "open", number: 7, body: "", updated_at: UPDATED_AT, author: "op-opilot")
      FakePr.new(
    ...
    def seed_pr_cache(comments: [], updated_at: UPDATED_AT, head_repo: "op-opilot/openproject")
    ...
    def test_clean_merge_pushes_without_a_claude_pass
      ...
      assert_equal [["op-opilot/openproject", "bug/42-fix", @repo.worktree_host]], @github.pushed,
    ...
    def test_bot_and_acted_comments_are_not_feedback
      ...
      seed_pr_cache(comments: [
        ...
        feedback_comment(at: "2026-01-01T11:00:00Z", id: 7, author: "op-opilot") # opilot's own
      ])
      out, = capture_io { @runner.run("42") }
      assert_includes out, "already fresh"
      assert_empty @harness.runs
    ...
    def test_wp_id_with_no_local_state_adopts_the_bots_open_pr_from_github
      ...
      assert_equal ['repo:opf/openproject is:pr is:open author:op-opilot "77" in:body'], @github.searches,
    ...
    # ── gh-agent's "@opilot refresh" entry point ────────────────────────────
    ...
    def test_canonical_head_is_discarded_even_on_an_interactive_yes
      ...
      assert_includes out, "which opilot never pushes to"
    end
