...
module OPilot
  module PD
    ...
    # the runner validates them — the same split as every other tool opilot uses.
    #
    ...
    class OpenSpec
      ...
      #
      # This is what keeps opilot aligned with OpenSpec instead of imitating it.
      ...
      # so without this the artifact format would live only in opilot's prompt —
